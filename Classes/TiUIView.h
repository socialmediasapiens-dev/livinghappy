...
/**
 Base class for all LivingHappy views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the LivingHappy view hierarchy (such as wrapped iOS UIViews) was touched.
