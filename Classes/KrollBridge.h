...
@interface LivingHappyObject : KrollCoverageObject {
#else
@interface LivingHappyObject : KrollObject {
#endif
@private
...
extern NSString * LivingHappy$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	LivingHappyObject *_livinghappy;
    KrollObject* console;
	BOOL shutdown;
