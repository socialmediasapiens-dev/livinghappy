...
/**
 The base class for all LivingHappy modules
 */
...
/**
 LivingHappy Platform calls this method on startup.
 */
-(void)startup;

/**
 LivingHappy Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 LivingHappy Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 LivingHappy Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 LivingHappy Platform calls this method on resume.
 @param sender The sender of the event.
 */
