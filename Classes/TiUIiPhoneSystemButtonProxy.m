...
MAKE_SYSTEM_PROP(ACTIVITY,UILivingHappyNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UILivingHappyNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UILivingHappyNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UILivingHappyNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UILivingHappyNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UILivingHappyNativeItemContactAdd);
