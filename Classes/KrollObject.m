...
//@interface LivingHappyObject : NSObject
//@end

@interface LivingHappyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LivingHappyObject class]])
		{
			for (NSString *key in [[(LivingHappyObject*)o modules] allKeys])
			{
