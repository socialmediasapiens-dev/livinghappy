...
// in simulator we redefine to format for LivingHappy Developer console
...
{\
	NSString * exceptionName = [@"org.livinghappy." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.livinghappy";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UILivingHappyNativeItemNone = -1, 
	UILivingHappyNativeItemSpinner = -2,
	UILivingHappyNativeItemProgressBar = -3,
	
	UILivingHappyNativeItemSlider = -4,
	UILivingHappyNativeItemSwitch = -5,
	UILivingHappyNativeItemMultiButton = -6,
	UILivingHappyNativeItemSegmented = -7,
	
	UILivingHappyNativeItemTextView = -8,
	UILivingHappyNativeItemTextField = -9,
	UILivingHappyNativeItemSearchBar = -10,
	
	UILivingHappyNativeItemPicker = -11,
	UILivingHappyNativeItemDatePicker = -12,
	
	UILivingHappyNativeItemInfoLight = -13,
	UILivingHappyNativeItemInfoDark = -14,
	
	UILivingHappyNativeItemDisclosure = -15,
	
	UILivingHappyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all LivingHappy instances of
